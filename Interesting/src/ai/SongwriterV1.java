...
public abstract class SongwriterV1 {
	...
	public SongwriterV1() throws IOException{
		setupNetwork();
		//train initial AI
		if (!readFromSave){
			train("Songs");
	...
	public void train(String file) throws IOException{
		BatchManager manager = new BatchManager(new File(file));
	...
	private class BatchManager{
		...
		BatchManager(File songs) throws IOException{
			this.songs = songs;
			reader = new Scanner(songs);
		}
