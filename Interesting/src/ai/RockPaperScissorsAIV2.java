...
public class RockPaperScissorsAIV2 {
	//--------------AI SPECIFIC SETTINGS AND VARIABLES------------------//
	private final int NUM_INPUTS = 250;
	...
	private final int NUM_TRAINING_REPS = 70000000;  //number of times the whole set of training cases is cycled through
	...
	{
		HIDDEN_LEVEL_SIZES = new int[]{60,60,50,50,100,100,100,100,100,100};
		for (int i = 0; i < NUM_INPUTS; i++){
			pastMoves.add(new Random().nextInt(3)+1);
		}
	}
	...
	public RockPaperScissorsAIV2() throws IOException{
		setupNetwork();
		//train initial AI
		if (!readFromSave){
			train("Songs");
