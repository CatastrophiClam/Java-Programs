...
public class RockPaperScissorsAIV1 {
	...
	private final int NUM_TRAINING_REPS = 4000;  //number of times the whole set of training cases is cycled through
	...
	public RockPaperScissorsAIV1() throws IOException{
		setupNetwork();
